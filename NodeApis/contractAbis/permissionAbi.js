...
var permission_contract_address = require("../migrations/ContractAddress.json").permission;

var permission_contractABI = require("../build/contracts/Permission.json").abi;
